...
object  MonadSpec extends Properties("Monad[F[_]] laws..") {
  ...
  ///flatMap must obey an associative law: go to p 196
  ...
  property ("of listMonad over integers") = monad[Int, List] (listMonad)
  property ("of listMonad over string") = monad[String, List] (listMonad)
